 ...
 */
public abstract class AbstractEntityEAAIHerder<J extends AbstractJob<?, J>, B extends AbstractBuildingHerder, T extends EnhancedAnimalAbstract> extends AbstractEntityAIInteract<J, B>
{
    /**
